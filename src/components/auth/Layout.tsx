    ...
    <div className="bg-black h-screen">
      <div className="container mx-auto h-full grid">
        <div className="grid grid-cols-2 w-full max-w-4xl h-5/6 md:h-4/5 m-auto p-4">
          <div className="hidden md:block bg-secondary text-white p-4 rounded-l-xl relative">
            <span>Cup</span>
            <div className="h-full flex flex-col justify-center">
              ...
              <img className="object-cover max-w-xs mx-auto rounded-xl" src="/assets/img01.jpeg" alt="Tree" />
            </div>
          ...
          <div className="bg-gray-100 text-primary p-6 md:p-4 rounded-r-xl rounded-l-xl md:rounded-l-none col-span-2 md:col-span-1 w-full max-w-lg mx-auto">
            <div className="flex justify-end">
              <div className="rounded-l-xl rounded-r-xl shadow-2xl">
                ...
                <Link to="/register" className="bg-primary hover:bg-primary-dark transition duration-500 text-gray-100 px-4 py-2 text-xs rounded-r-xl">
                  Sign in
                </Link>
              </div>
            </div>
